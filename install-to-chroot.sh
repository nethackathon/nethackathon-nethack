...
#
# NEVER `cp` over a file in a live chroot. `cp` opens the destination O_TRUNC,
# so an existing file is briefly zero-length WHILE games hold it open:
#   - every running nethack holds nethackathon/nhdat open for the whole session
